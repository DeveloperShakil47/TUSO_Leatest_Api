...
namespace TUSO.Infrastructure.SqlServer.Migrations
{
    ...
    [Migration("20231220171041_Initial Migration for new database")]
            ...
            modelBuilder.Entity("TUSO.Domain.Entities.UserAccount", b =>
                {
                    ...
                    b.HasOne("TUSO.Domain.Entities.Facility", null)
                        .WithMany("UserAccounts")
                        .HasForeignKey("FacilityOid");
